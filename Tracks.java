...
public class Tracks extends AppCompatActivity {
    ...
    //Method for making a toast when the play button is pushed
    public void showPlaying(Mumbo currentSong){
        Toast.makeText(this, R.string.nowPlaying , Toast.LENGTH_SHORT).show();
    }

    //Method for making a toast when the add button is pushed
    public void addToPlaylist(Mumbo currentSong){
        Toast.makeText(this, R.string.addtoPlaylist , Toast.LENGTH_SHORT).show();
        Intent playlistIntent = new Intent(this, MyPlaylist.class);
        playlistIntent.putExtra("song", currentSong.getSongByArtist());
        playlistIntent.putExtra("artist", currentSong.getMusicalArtist());
        playlistIntent.putExtra("album", currentSong.getAlbumLP());
